...
-- --correct 
insert into students (student_fname, student_lname, student_email,student_phone, years_of_exp, student_company, batch_date,source_of_joining, location, enrollment_date) 
values('virat', 'kohli','virat@gmail.com', '9292929292', 3, 'flipkart', '2021-02-05','linkedin', 'hyderabad',now());
insert into students(student_fname, student_lname, student_email,student_phone, years_of_exp, batch_date, source_of_joining,location)
